      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="glass p-6 rounded-2xl order-2 md:order-1">
          <div className="flex items-center gap-3 pb-4 mb-5 border-b border-white/5">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal to-teal-light flex items-center justify-center text-navy font-bold">🤖</div>
            <div>
              <p className="font-semibold text-sm">KEZ AI Mentor</p>
              <p className="text-xs text-teal flex items-center gap-1"><span className="w-1.5 h-1.5 rounded-full bg-teal animate-pulse inline-block" />Faol — javobga tayyor</p>
            </div>
          </div>
          <div className="space-y-3">
            <div className="ml-auto w-fit max-w-[80%] bg-teal/10 border border-teal/20 rounded-2xl rounded-br-sm px-4 py-2.5 text-sm">
            ...
            <div className="mr-auto w-fit max-w-[80%] bg-white/5 border border-white/8 rounded-2xl rounded-bl-sm px-4 py-2.5 text-sm leading-relaxed">
              ...
              <code className="text-teal-light text-xs bg-teal/15 px-1 rounded">[x*2 for x in range(5)]</code><br />
              Bu <code className="text-teal-light text-xs bg-teal/15 px-1 rounded">[0,2,4,6,8]</code> qaytaradi. Sodda, tez va pythonic! Misol kerakmi?
            </div>
            <div className="ml-auto w-fit max-w-[80%] bg-teal/10 border border-teal/20 rounded-2xl rounded-br-sm px-4 py-2.5 text-sm">
