    ...
    <section id="how" className="py-24 px-4 bg-navy-2">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
          <div className="absolute hidden lg:block top-8 left-[12%] right-[12%] h-px bg-gradient-to-r from-transparent via-teal to-transparent opacity-30" />
          {steps.map(({ n, title, desc }) => (
            <div key={n} className="text-center relative">
              <div className="w-14 h-14 rounded-full bg-gradient-to-br from-teal to-teal-light text-navy font-mono font-bold text-lg flex items-center justify-center mx-auto mb-4 shadow-[0_0_24px_rgba(0,188,212,.4)]">
                {n}
              </div>
